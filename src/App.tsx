import PokemonWrapper from "./features/pokemons/PokemonWrapper"
import PokeList from "./features/pokemons/PokeList"
import PokeDetail from "./features/pokemons/PokeDetail"
        ...
        <main>
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <PokemonWrapper>
              ...
              <div>
                <h1 className="text-slate-500 text-3xl mx-2">PokeList</h1>
                <hr className="my-4" />
                <PokeList />
              </div>
              <div>
                <h1 className="text-slate-500 text-3xl mx-2">Poke Detail</h1>
                <hr className="my-4" />
                <PokeDetail />
              </div>
              </div>
